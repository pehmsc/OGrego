...
import {
    ...
    CardTitle,
    CardDescription,
} from "@/components/ui/(userProfile)/card";
import { Label } from "@/components/ui/(userProfile)/label";
import { Input } from "@/components/ui/(userProfile)/input";
import { Button } from "@/components/ui/(userProfile)/button";
import { Separator } from "@/components/ui/(userProfile)/separator";
            ...
            <Card className="rounded-3xl border-[#1E3A8A]/10 bg-white/70 shadow-sm">
                <CardHeader className="space-y-2">
                    ...
                    <CardDescription className="text-zinc-600/90">
                        Crie a sua conta para acompanhar pedidos e gerir o seu
                        perfil.
                    </CardDescription>
                </CardHeader>
