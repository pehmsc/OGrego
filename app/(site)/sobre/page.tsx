    ...
    return (
        <section className="grid gap-14">
            <header className="grid gap-6">
                ...
                <h2 className="max-w-2xl text-4xl font-semibold tracking-tight text-[#1E3A8A] sm:text-4xl">
                ...
                <p className="max-w-3xl text-lg leading-8 text-zinc-600/90 dark:text-zinc-400/90">
                    O Grego nasceu numa ideia muito simples (e muito atual):
                    trazer de volta o prazer de estar à mesa sem pressa. Cozinha
                    mediterrânica, ingredientes frescos e um ambiente que pede
                    conversa.
                </p>
            </header>
            <div className="grid gap-10 lg:grid-cols-2 lg:items-center">
                ...
                <div className="grid gap-6">
                    ...
                    <p className="leading-7 text-zinc-600/90 dark:text-zinc-400/90">
                        Em 2024, no meio de horários impossíveis e refeições “a
                        correr”, dois amigos (um cozinheiro e uma arquiteta)
                        decidiram abrir um espaço onde o tempo voltava a contar.
                        A inspiração veio de uma viagem às ilhas gregas: paredes
                        claras, azul profundo, mesas que parecem durar horas e
                        comida que sabe a verão — mesmo em pleno inverno.
                    </p>

                    <p className="leading-7 text-zinc-600/90 dark:text-zinc-400/90">
                        O objetivo nunca foi inventar a roda. Foi fazer bem o
                        essencial: pratos honestos, sabor intenso, simplicidade
                        elegante. E um ambiente que não grita — convida.
                    </p>
            ...
            <div className="grid gap-6 lg:grid-cols-3">
                {[
                    ...
                    },
                    {
                        ...
                        text: "Pratos pensados para dividir. Porque a experiência é melhor em conjunto.",
                    },
                ].map((card) => (
                    <div
                        key={card.title}
            ...
            <div className="rounded-3xl border border-[#1E3A8A]/10 bg-[#F4F7FB] p-10 text-center shadow-sm">
                <p className="mx-auto max-w-3xl text-lg leading-8 text-[#1E3A8A]/85">
                    A mesa é o centro. O resto é ruído.
                    <br></br>Aqui, come-se devagar, conversa-se mais e volta-se
                    sempre.
                </p>
            </div>
        </section>
