...
export default function CheckoutPage() {
  ...
  const fallbackDeliveryFeeCents =
    formData.orderType === "delivery" && fallbackSubtotalCents < 3000 ? 250 : 0;
      ...
      <main className="mx-auto max-w-4xl px-4 py-12">
        <div className="rounded-3xl border border-amber-200 bg-amber-50 p-12 text-center shadow-sm">
          ...
          <p className="mb-6 text-amber-800">
            Para emitir recibo fiscal é necessário ter o NIF preenchido no
            perfil. Adicione o seu NIF e volte para finalizar a encomenda.
          </p>
          <div className="flex flex-col gap-3 sm:flex-row sm:justify-center">
            <Link
              href="/user/profile"
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          <section className="rounded-3xl border border-[#1E3A8A]/10 bg-white/80 p-6">
            ...
            >
              ...
              <option value="cash">Dinheiro (na entrega/levantamento)</option>
            ...
            {(userData?.points ?? 0) > 0 && (
              <div className="rounded-3xl border border-[#1E3A8A]/10 bg-gradient-to-br from-amber-50 to-orange-50 p-6">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="text-xs text-amber-800">Tem disponível</p>
            ...
            <section className="rounded-3xl border border-[#1E3A8A]/10 bg-white/80 p-6">
              ...
              <div className="space-y-3">
                  ...
                  <input
                    ...
                    onKeyDown={(e) => {
                      if (e.key === "Enter") {
                        ...
                        if (inputValue) {
                          setPromoCode(inputValue.toUpperCase());
                        }
                      }
                    }}
                  ...
                  <button
                    ...
                    onClick={(e) => {
                      ...
                      if (inputValue) {
                        ...
                        setPromoMessage("Insira um código");
                      }
                    }}
                ...
                {promoCode.trim() && isPricingLoading ? (
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-xs text-blue-600">
                          Código: <span className="font-mono">{promoCode}</span>
                        </p>
                      </div>
                    </div>
                  </div>
                    ...
                    <div className="flex items-start justify-between gap-3">
                      <div className="flex-1">
                        ...
                        <p className="text-xs text-red-700 mt-2">
                          Verifique se o código está correto e ativo.
                        </p>
                      </div>
                      <button
                        type="button"
                  ...
                  <p className="text-xs text-gray-600">
                    Digite o código e clique em &quot;Aplicar&quot; para validar
                  </p>
                )}
              </div>
            </section>
