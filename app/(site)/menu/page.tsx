  ...
  return (
    <section className="w-full space-y-8 py-6">
      ...
      <header className="space-y-2">
        <h1 className="text-3xl font-semibold text-[#1E3A8A]">{tituloSite}</h1>
          ...
          >
            ...
            <div className="p-4 space-y-2">
              <div className="flex items-center justify-between gap-2">
                <h2 className="text-base font-semibold">{item.nome[lang]}</h2>
              ...
              {item.descricao && (
                <p className="text-sm text-gray-600">{item.descricao[lang]}</p>
              )}
            </div>
          </article>
        ))}
