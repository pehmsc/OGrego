...
console.log("CardDrawer importado:", CartDrawer);
            ...
            <SignedIn>
              <>
                ...
                <button
                  ...
                  className="cursor-pointer relative flex h-12 w-12 items-center justify-center rounded-full border border-[#1E3A8A]/20 bg-white/80 transition-all hover:border-[#1E3A8A]/40 hover:bg-[#F4F7FB] hover:-translate-y-[1px] hover:shadow-sm"
