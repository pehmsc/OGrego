...
import { HomeHeroAuthCta } from "@/app/ui/components/home-hero-auth-cta";
                    ...
                    <div className="grid gap-8 text-center lg:text-left">
                        ...
                        <div className="grid gap-5">
                            ...
                            <p className="mx-auto max-w-xl text-base leading-7 text-zinc-700/90 dark:text-zinc-200/85 sm:text-lg sm:leading-8 lg:mx-0">
                                No O Grego, a tradição mediterrânica encontra-se
                                com ingredientes frescos, sabores intensos e uma
                                cozinha feita com tempo e respeito.
                                <br />
                                Cada prato é uma viagem — simples, honesta e
                                cheia de carácter.
                                <br />
                                Aqui, come-se devagar, conversa-se mais e
                                volta-se sempre.
                            </p>
                        </div>
