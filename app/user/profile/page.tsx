      ...
      <div className="rounded-3xl border border-[#1E3A8A]/10 bg-white/80 p-8 shadow-sm">
        <div className="flex flex-col gap-6 lg:flex-row lg:items-center">
          ...
          <div className="flex-1">
            ...
            <p className="mt-1 text-lg text-zinc-600/90">{user.email}</p>
      ...
      <div className="grid gap-8 lg:grid-cols-3">
            ...
            <form action={updateProfile} className="grid gap-6">
              ...
              <div>
                ...
                >
                  ...
                  <option value="O Grego Lisboa">O Grego Lisboa</option>
        ...
        <div className="lg:col-span-1">
          <div className="rounded-3xl border border-[#1E3A8A]/10 bg-gradient-to-br from-yellow-400 to-yellow-600 p-8 text-white shadow-sm">
            ...
            <div className="mb-6">
              <p className="text-sm font-medium text-yellow-100">Saldo Atual</p>
